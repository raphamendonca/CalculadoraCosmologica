package com.example.rhapsody.cosmocalc;

import android.app.Activity;
import android.view.View;

/**
 * Created by rhapsody on 28/05/17.
 */
...
public class Calculadora extends Activity implements View.OnClickListener {
    ...
    private int n=1000;	// number of points in integrals
    private int nda = 1;	// number of digits in angular size distance
    private double H0 = 69.6;	// Hubble constant
    private double WM = 0.286;	// Omega(matter)
    private double WV = 0.714;	// Omega(vacuum) or lambda
    private double WR = 0;	// Omega(radiation)
    private double WK = 0;	// Omega curvaturve = 1-Omega(total)
    private double z = 3.0;	// redshift of the object
    private double h = 0.696;	// H0/100
    private double c = 299792.458; // velocity of light in km/sec
    private double Tyr = 977.8; // coefficent for converting 1/H into Gyr
    private double DTT = 0.5;	// time from z to now in units of 1/H0
    private double  DTT_Gyr = 0.0;	// value of DTT in Gyr
    private double  age = 0.5;	// age of Universe in units of 1/H0
    private double  age_Gyr = 0.0;	// value of age in Gyr
    private double  zage = 0.1;	// age of Universe at redshift z in units of 1/H0
    private double  zage_Gyr = 0.0;	// value of zage in Gyr
    private double  DCMR = 0.0;	// comoving radial distance in units of c/H0
    private double  DCMR_Mpc = 0.0;
    private double  DCMR_Gyr = 0.0;
    private double  DA = 0.0;	// angular size distance
    private double  DA_Mpc = 0.0;
    private double  DA_Gyr = 0.0;
    private double  kpc_DA = 0.0;
    private double  DL = 0.0;	// luminosity distance
    private double  DL_Mpc = 0.0;
    private double  DL_Gyr = 0.0;	// DL in units of billions of light years
    private double  V_Gpc = 0.0;
    private double  a = 1.0;	// 1/(1+z), the scale factor of the Universe
    private double  az = 0.5;	// 1/(1+z(object))
    ...
    private void defineValues(double tH0, double tWM, double tWV, double tz){
        H0 = tH0;
        h = H0/100;
        WM = tWM;
        WV = tWV;
...
// do integral over a=1/(1+z) from az to 1 in n steps, midpoint rule
    ...
    function display() {
        ...
        var answer = '<P>For <A HREF="./glossary.html#H0">H<SUB>o</SUB></A> = ' +
                H0 + ', <A HREF="./glossary.html#Omega">Omega<SUB>M</SUB></A> = ' +
                stround(WM,3) +
                ', <A HREF="./glossary.html#CC">Omega<SUB>vac</SUB></A> = ' +
                stround(WV,3) +
